      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="view_konfirmasi_pengajuan_super.php" class="nav-link active bg-warning">
                      ...
                      if(isset($_GET['acc'])){
                        if($_GET['acc'] == "success"){
                          echo "
                            ...
                            <div class='alert bg-teal alert-dismissible'>
                              ...
                              <strong>Berhasil melakukan konfirmasi pengajuan</strong>
                            </div>
                            </center>
                          ";
                        }
                                            
                        else if ($_GET['acc'] == "error") {
                          echo "
                            <center>
                            <div class='alert alert-danger alert-dismissible'>
                              <button type='button' class='close' data-dismiss='alert'>&times;</button>
                              <strong>Dana keseluruhan telah habis</strong>
                            </div>
                            </center>
                          ";
                        }
                        ...
                        if($_GET['delete'] == "success"){
                          echo "
                            ...
                            <div class='alert bg-teal alert-dismissible'>
                              <button type='button' class='close' data-dismiss='alert'>&times;</button>
                              <strong>Berhasil menghapus data konfirmasi</strong>
                            </div>
                            </center>
                          ";
                        }
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php
                      ...
                      $result= mysqli_query($conn, "SELECT * FROM dana_perbidang INNER JOIN akun ON dana_perbidang.id_akun = akun.id_akun");
                    ...
                    <tr>
                      ...
                      <td>
                        <center>
                          <a href="<?php echo "detail_konfirmasi_pengajuan_super.php?id_dana=".$data['id_dana']; ?>" class="btn btn-warning btn-circle btn-sm" data-toggle="tooltip" title="Detail">
                            <i class="fas fa-info-circle"></i>
                          </a>
                          <a href="<?php echo "delete_konfirmasi_pengajuan_super_action.php?id_dana=".$data['id_dana']; ?>" class="btn btn-danger btn-circle btn-sm" data-toggle="tooltip" title="Delete">

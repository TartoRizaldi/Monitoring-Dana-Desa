        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Pemberdayaan Masyarakat</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    $result= mysqli_query($conn, "SELECT * FROM dana_perbidang INNER JOIN akun ON dana_perbidang.id_akun = akun.id_akun WHERE bidang='Pemberdayaan Masyarakat'");

        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="view_keperluan_admin.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Keperluan</p>
                </a>
              </li>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php
                      ...
                      $result= mysqli_query($conn, "SELECT * FROM dana_perbidang INNER JOIN akun ON dana_perbidang.id_akun = akun.id_akun WHERE username='$akun'");
                    ...
                    <tr>
                      ...
                      <td>
                        <center>
                          <a href="<?php echo "detail_keperluan_super.php?id_dana=".$data['id_dana']; ?>" class="btn btn-warning btn-circle btn-sm" data-toggle="tooltip" title="Detail">
                            <i class="fas fa-info-circle"></i>
                          </a>
                          <a href="<?php echo "delete_keperluan_super_action.php?id_dana=".$data['id_dana']; ?>" class="btn btn-danger btn-circle btn-sm" data-toggle="tooltip" title="Delete">

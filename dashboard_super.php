      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="dashboard_super.php" class="nav-link active bg-warning">
            ...
            <td>
              <center>
                <div class="alert alert-warning alert-dismissible">
                  ...
                  Selamat Datang <strong>Super</strong>
                </div>
              </center>
            </td>
          </tr>
            ...
            <td>
              <div class="row">
                <div class="col-lg-3 col-6">
                  <!-- small box -->
                  <div class="small-box bg-info" style="cursor: pointer;" onclick="window.location='view_pemerintahan_super.php';">
                    <div class="inner">
                      <h4>
                        <?php
                          require ('koneksi.php');
                ...
                <div class="col-lg-3 col-6">
                  <!-- small box -->
                  <div class="small-box bg-teal" style="cursor: pointer;" onclick="window.location='view_pembangunan_super.php';">
                    <div class="inner">
                      <h4>
                        <?php
                            require ('koneksi.php');
                ...
                <div class="col-lg-3 col-6">
                  <!-- small box -->
                  <div class="small-box yellow" style="cursor: pointer;" onclick="window.location='view_pembinaan_super.php';">
                    <div class="inner">
                      <h4 class="white">
                        <?php
                            require ('koneksi.php');
                ...
                <div class="col-lg-3 col-6">
                  <!-- small box -->
                  <div class="small-box bg-danger" style="cursor: pointer;" onclick="window.location='view_pemberdayaan_super.php';">
                    <div class="inner">
                      <h4>
                        <?php
                          require ('koneksi.php');
                ...
                <div class="col-lg-3 col-6">
                  <!-- small box -->
                  <div class="small-box bg-secondary" style="cursor: pointer;" onclick="window.location='view_takterduga_super.php';">
                    <div class="inner">
                      <h4>
                        <?php
                          require ('koneksi.php');

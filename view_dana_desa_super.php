        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="view_dana_desa_super.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Data Dana</p>
                </a>
              </li>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <center>
                          <a href="<?php echo "update_dana_desa_super.php?id_dana=".$data['id_dana']; ?>" class="btn btn-primary btn-circle btn-sm" data-toggle="tooltip" title="Edit">
                            <i class="fas fa-pencil-alt"></i>
                          </a>
                          <a href="<?php echo "delete_dana_desa_super_action.php?id_dana=".$data['id_dana']; ?>" class="btn btn-danger btn-circle btn-sm" data-toggle="tooltip" title="Delete">

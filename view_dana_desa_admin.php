        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="view_dana_desa_admin.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Data Dana</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Input Data Dana</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Monitoring</li>
              <li class="breadcrumb-item active">Data Dana</li>
              <li class="breadcrumb-item active">Input Data Dana</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="space_d">
      ...
      <div class="card">
              ...
              <div class="card-body">
                <div class="info-box">
                <span class="info-box-icon bg-warning"><i class="far"></i></span>

                  <div class="info-box-content">
                    <span class="info-box-text">Dana Saat Ini</span>
                    <span class="info-box-number">
                      <?php
                        require ('koneksi.php');
                        $result= mysqli_query($conn, "SELECT total FROM total_dana");
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    $result= mysqli_query($conn, "SELECT * FROM dana_desa INNER JOIN akun ON dana_desa.id_akun = akun.id_akun");
                  ...
                  ?>
                    ...
                    <tr>
                      <td><?php echo $no++; ?></td>
                      <td><?php echo $data['asal_dana']; ?></td>
                      <td><?php echo "Rp. ".number_format($data['jumlah_dana']); ?></td>
                      <td>
                        <?php 
                          $tanggal =  date_create($data['tanggal_dana']);
                      ...
                      <td>
                        <center>
                          <a href="<?php echo "update_dana_desa_admin.php?id_dana=".$data['id_dana']; ?>" class="btn btn-primary btn-circle btn-sm" data-toggle="tooltip" title="Edit">
                            <i class="fas fa-pencil-alt"></i>
                          </a>
                          <a href="<?php echo "delete_dana_desa_admin_action.php?id_dana=".$data['id_dana']; ?>" class="btn btn-danger btn-circle btn-sm" data-toggle="tooltip" title="Delete">

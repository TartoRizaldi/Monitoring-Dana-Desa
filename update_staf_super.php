<?php
    ...
    $id = $_GET['id_akun'];
    $dataUbah = mysqli_query($conn, "SELECT * FROM akun WHERE id_akun='$id'");
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Update Data Staf</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Monitoring</li>
              <li class="breadcrumb-item active">Data Staf</li>
              <li class="breadcrumb-item active">Update Data Staf</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <form autocomplete="off" action="<?php echo "update_staf_super_action.php?id_akun=".$data['id_akun']; ?>" method="POST">
          ...
          <tr>
            <td>
              <div class="form-group">
                <label class="col-form-label" for="inputWarning"><i class="far fa-user"></i> Nama Staf</label>
                <input type="text" class="form-control is-warning" id="inputWarning" placeholder="Enter ..." name="nama" required="" value="<?php echo $data['nama_akun']; ?>">
              </div>
              <div class="form-group">
                <label class="col-form-label" for="inputWarning"><i class="far fa-user"></i> Username</label>
                <input type="text" class="form-control is-warning" id="inputWarning" placeholder="Enter ..." name="username" required="" value="<?php echo $data['username']; ?>">
              </div>
              <div class="form-group">
                <label class="col-form-label" for="inputWarning"><i class="far fa-user"></i> Password</label>
                <input type="text" class="form-control is-warning" id="inputWarning" placeholder="Enter ..." name="password" required="" value="<?php echo $data['password']; ?>">
              </div>
              <br>
